 ...
 */
public class FindNearbyCinemasAdapter extends RecyclerView.Adapter<FindNearbyCinemasAdapter.MyViewHolder> {


    private Context mContext;

    private List<FindNearbyCinemasEntity.ResultBean> result;


    public FindNearbyCinemasAdapter(Context context, List<FindNearbyCinemasEntity.ResultBean> result) {
        mContext = context;
        this.result = result;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        FindNearbyCinemasEntity.ResultBean resultBean = result.get(position);//影院名字
